...
export default function RoomList({ rooms, setRooms, user, onEnterRoom, profiles }) {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", height: "100%" }}>
      {/* 헤더 */}
      <div style={{ padding: "16px 20px", borderBottom: "1px solid #E5E7EB", fontWeight: 700, fontSize: 16, color: T.text, display: "flex", alignItems: "center", justifyContent: "space-between" }}>
